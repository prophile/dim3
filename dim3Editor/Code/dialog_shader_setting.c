		...
		case kEventProcessCommand:
			...
			switch (cmd.commandID) {
				...
				case kTextureSettingButtonSetVertexShader:
					if (dialog_file_open_run("VertexShaderOpen","Shaders","vert",shader_name)) dialog_set_text(dialog_shader_wind,kTextureSettingVertexShader,0,shader_name);
					return(noErr);
				...
				case kTextureSettingButtonSetFragmentShader:
					if (dialog_file_open_run("FragmentShaderOpen","Shaders","frag",shader_name)) dialog_set_text(dialog_shader_wind,kTextureSettingFragmentShader,0,shader_name);
					return(noErr);
