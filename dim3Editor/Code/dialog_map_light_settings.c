...
#define kLightConfine								FOUR_CHAR_CODE('lcpt')
...
bool dialog_map_light_settings_run(map_light_type *light)
{
	...
	dialog_set_boolean(dialog_map_light_settings_wind,kLightConfine,0,light->confine_to_portal);
	...
	if (!dialog_map_light_settings_cancel) {
		...
		light->confine_to_portal=dialog_get_boolean(dialog_map_light_settings_wind,kLightConfine,0);
