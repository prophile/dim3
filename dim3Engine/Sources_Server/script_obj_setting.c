...
script_js_property	obj_setting_props[]={
							{"id",					obj_setting_prop_id,						TRUE},
							{"name",				obj_setting_prop_name,						TRUE},
							{"team",				obj_setting_prop_team,						FALSE},
							{"hidden",				obj_setting_prop_hidden,					FALSE},
							{"suspend",				obj_setting_prop_suspend,					FALSE},
							{"fly",					obj_setting_prop_fly,						FALSE},
							{"find",				obj_setting_prop_find,						FALSE},
							{"contact",				obj_setting_prop_contact,					FALSE},
							{"contactObject",		obj_setting_prop_contact_object,			FALSE},
							{"contactProjectile",	obj_setting_prop_contact_projectile,		FALSE},
							{"contactForce",		obj_setting_prop_contact_force,				FALSE},
							{"hitBox",				obj_setting_prop_hit_box,					FALSE},
							{"damage",				obj_setting_prop_damage,					FALSE},
							{"crushable",			obj_setting_prop_crushable,					FALSE},
							{"invincible",			obj_setting_prop_invincible,				FALSE},
							{"clickable",			obj_setting_prop_clickable,					FALSE},
							{"pickUp",				obj_setting_prop_pickup,					FALSE},
							{"ignorePickUpItems",	obj_setting_prop_ignore_pickup_items,		FALSE},
							{"ignoreMouse",			obj_setting_prop_ignore_mouse,				FALSE},
							{"turnOnlyWhenMoving",	obj_setting_prop_turn_only_when_moving,		FALSE},
							{"restrictPlayerTurning",obj_setting_prop_restrict_player_turning,	FALSE},
							{"quickReverse",		obj_setting_prop_quick_reverse,				FALSE},
							{"sideStep",			obj_setting_prop_side_step,					FALSE},
							{"jump",				obj_setting_prop_jump,						FALSE},
							{"duck",				obj_setting_prop_duck,						FALSE},
							{"crawl",				obj_setting_prop_crawl,						FALSE},
							{"singleSpeed",			obj_setting_prop_single_speed,				FALSE},
							{"bumpUp",				obj_setting_prop_bump_up,					FALSE},
							{"slopeGravity",		obj_setting_prop_slope_gravity,				FALSE},
							{"pushable",			obj_setting_prop_pushable,					FALSE},
							{"openDoors",			obj_setting_prop_open_doors,				FALSE},
							{"inputMode",			obj_setting_prop_input_mode,				FALSE},
							{0}};
