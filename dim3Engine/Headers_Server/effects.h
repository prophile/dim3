...
extern void decal_move_for_mesh(int portal_idx,int mesh_idx,int xmove,int ymove,int zmove);
extern void decal_add_poly(d3pos *pos,poly_pointer_type *poly_ptr,int mark_idx,int sz,float alpha);
