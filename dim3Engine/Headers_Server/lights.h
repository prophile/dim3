...
extern void light_add(d3pnt *pnt,int light_type,int intensity,d3col *col);
extern int light_create_glsl_array(d3pnt *pnt,d3pnt *camera_pnt,float *light_pos,float *light_col,float *light_normal);
...
extern void map_calculate_light_reduce_save(map_mesh_type *mesh);
