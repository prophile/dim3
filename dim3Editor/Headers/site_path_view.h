...
extern void site_path_view_draw(int drag_hilite_rn);
extern void site_path_view_click(Point pt,bool dblclick);
extern void site_path_view_cursor(void);
extern void site_path_view_key(char ch);
extern void site_path_view_center(void);
extern void site_path_view_reset(void);
...
extern void site_path_view_draw_portal_walls(int rn);
...
extern int site_path_view_select_portal(Point pt);
extern int site_path_view_find_open_sight(void);
extern void site_path_view_mouse_move(Point pt);
extern bool site_path_view_cut_sight(Point pt);
extern bool site_path_view_click_sight(Point pt);
