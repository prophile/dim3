...
extern bool object_move_xz(obj_type *obj,int xmove,int zmove);
extern void object_move_y(obj_type *obj,int ymove);
extern void object_fly_y(obj_type *obj,int ymove);
...
extern void object_duck(obj_type *obj);
