...
JSPropertySpec	proj_motion_vector_props[]={
							{"x",					proj_motion_vector_prop_x,			JSPROP_READONLY|JSPROP_PERMANENT|JSPROP_SHARED},
							{"y",					proj_motion_vector_prop_y,			JSPROP_READONLY|JSPROP_PERMANENT|JSPROP_SHARED},
							{"z",					proj_motion_vector_prop_z,			JSPROP_READONLY|JSPROP_PERMANENT|JSPROP_SHARED},
							{0}};
