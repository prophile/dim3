...
void network_get_host_name(char *name)
{
	char			*c;
...
void network_get_host_ip(char *ip_name,char *ip_resolve)
{
	int					addr[4];
	unsigned long		ul;
	bool				resolved;
...
void network_ip_local_broadcast(char *ip,char *broad_ip)
{
	char			*c;
